---
name: supabase
description: Database, auth, and backend expertise for Supabase operations in Finandance id project: dgclzjtyfneztonwktyg
...
Provides comprehensive expertise for Supabase development in Finandance id project: dgclzjtyfneztonwktyg
@mcp-server:supabase-personal
